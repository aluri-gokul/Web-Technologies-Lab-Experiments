  ...
  $con=mysqli_connect("localhost","root","","facebook");
        ...
        while($row=mysqli_fetch_array($rows))
        {
          ...
          echo "<br>";
            ...
            echo "<form method='post' action='post.php'>";
            echo "<button name='co' style='border:none; color:#fff; border-radius:10px; background-color:blue; padding:5px;width:35px; font-size:16px; margin-left:164px;margin-top:-45px;'>$count</button>";
            echo "</div>";
            echo "</div>";
            echo "</form>";
